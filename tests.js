...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Reducer = __webpack_require__(/*! ./Test/Reducer */ 41);
	
	var _Reducer2 = _interopRequireDefault(_Reducer);
	
	var _Middleware = __webpack_require__(/*! ./Test/Middleware */ 74);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _deepFreeze = __webpack_require__(/*! deep-freeze */ 73);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Expectation = __webpack_require__(/*! ./Expectation */ 43);
	
	var _Expectation2 = _interopRequireDefault(_Expectation);
	
	var _SpyUtils = __webpack_require__(/*! ./SpyUtils */ 54);
	
	var _assert = __webpack_require__(/*! ./assert */ 52);
	
	var _assert2 = _interopRequireDefault(_assert);
	
	var _extend = __webpack_require__(/*! ./extend */ 72);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _has = __webpack_require__(/*! has */ 44);
	
	var _has2 = _interopRequireDefault(_has);
	
	var _tmatch = __webpack_require__(/*! tmatch */ 47);
	...
	var _TestUtils = __webpack_require__(/*! ./TestUtils */ 59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../process/browser.js */ 20), __webpack_require__(/*! ./../buffer/index.js */ 48).Buffer))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _objectInspect = __webpack_require__(/*! object-inspect */ 53);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _defineProperties = __webpack_require__(/*! define-properties */ 55);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var keys = __webpack_require__(/*! object-keys */ 56);
	var foreach = __webpack_require__(/*! foreach */ 58);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toStr = Object.prototype.toString;
	var slice = Array.prototype.slice;
	var isArgs = __webpack_require__(/*! ./isArguments */ 57);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isRegex = __webpack_require__(/*! is-regex */ 60);
	
	var _isRegex2 = _interopRequireDefault(_isRegex);
	
	var _why = __webpack_require__(/*! is-equal/why */ 61);
	
	var _why2 = _interopRequireDefault(_why);
	
	var _objectKeys = __webpack_require__(/*! object-keys */ 56);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var has = __webpack_require__(/*! has */ 44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var has = __webpack_require__(/*! has */ 44);
	var isArrowFunction = __webpack_require__(/*! is-arrow-function */ 62);
	var isBoolean = __webpack_require__(/*! is-boolean-object */ 64);
	var isDate = __webpack_require__(/*! is-date-object */ 65);
	var isGenerator = __webpack_require__(/*! is-generator-function */ 66);
	var isNumber = __webpack_require__(/*! is-number-object */ 67);
	var isRegex = __webpack_require__(/*! is-regex */ 60);
	var isString = __webpack_require__(/*! is-string */ 68);
	var isSymbol = __webpack_require__(/*! is-symbol */ 69);
	var isCallable = __webpack_require__(/*! is-callable */ 63);
	...
	var symbolIterator = __webpack_require__(/*! ./getSymbolIterator */ 70)();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createComposite = function createComposite() {
	    return (0, _index.Structure)({ toggle: _Reducer.toggle, calc: [(0, _index.Composite)({ reducer: _Reducer.increment, middleware: middlewareIncrementCallback }), (0, _index.Composite)({ reducer: _Reducer.calculator, middleware: middlewareCalcCallback })] });
	};
	
	var test = function test() {
	    var composite = createComposite();
	    var store = composite.createStore()(function (r) {
	        return r;
	    ...
	    var complexStore = complex.createStore()(function (r) {
	        return r;
	    ...
	    var anotherComplexStore = anotherComplex.createStore()(function (r) {
	        return r;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var test1 = function test1(memoize, dispatch) {
	...
	var test2 = function test2(memoize, dispatch) {
	    // custom memoize
	    var custom = (0, _MemoizeChain2.default)(memoize.structure.toggle.memoize, memoize.structure.calc[0].memoize)(someFunction);
	
	    (0, _expect2.default)(custom(15, 16)).toEqual(31);
	    dispatch({ type: 'COMPOSITE', composite: {
	            toggle: { type: 'TOGGLE' }
	        } });
	...
	var test3 = function test3(createComposite) {
	    ...
	    // Expected behavior
	    (0, _expect2.default)(finalMemoize1()).toEqual(2);
	    ...
	    (0, _expect2.default)(finalMemoize1()).toEqual(-1);
	    ...
	    (0, _expect2.default)(calculated).toEqual({ total: 5, structure: { toggle: 5, calc: [3, 2] } });
	    store.dispatch({ type: 'COMPOSITE', composite: { toggle: { type: 'TOGGLE' } } });
	    ...
	    var complexStore = complexComposite.createStore()(function (r) {
	        return r;
	    }, { increment: 1, reducer: { toggle: false, calc: [0, 1] } });
...
/***/ (function(module, exports) {
	...
	var MemoizeChain = exports.MemoizeChain = function MemoizeChain() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var test = function test() {
	    ...
	    (0, _expect2.default)(composite.getState()).toEqual({ toggle: false, calc: [1, 1] });
	    ...
	    (0, _expect2.default)(complex.getState()).toEqual({
	        increment: 2,
	        reducer: {
	            toggle: true,
	            calc: [2, 1]
